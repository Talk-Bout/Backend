...
import { createCommunityComment, readCommunityComment, updateCommunityComment, deleteCommunityComment } from "../services"

export default class BootcampController implements Controller {
    public readonly router = Router()
    public readonly path = '/community/:communityId/communityComments'
    ...
    private initializeRoutes() {
        ...
        this.router.route(this.path + '/:communityCommentId')
